...
class Networking {
    ...
    enum ParameterEncoding {
        ...
        func encode(_ jsonData: NSMutableURLRequest, parameters: [String: AnyObject]?) -> Foundation.URLRequest {
            guard let parameters = parameters, let mutableURLRequest = jsonData.mutableCopy() as? NSMutableURLRequest  else {
                return jsonData as URLRequest
            }
